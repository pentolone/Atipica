...
/**
 * ProfessioneSearch represents the model behind the search form of `\app\models\Professione`.
 */
class ProfessioneSearch extends Professione
{
    /**
     * @inheritdoc
     */
