...
/**
 * StatocivileSearch represents the model behind the search form of `\app\models\Statocivile`.
 */
class StatocivileSearch extends Statocivile
{
    /**
     * @inheritdoc
     */
