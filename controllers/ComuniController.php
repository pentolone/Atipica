...
class ComuniController extends Controller
{
    ...
    {
    	  if((Yii::$app->user->id == 1) || Yii::$app->user->can('create-comune') ) {
             $model = new Comuni();
    ...
    {
    	  if((Yii::$app->user->id == 1) || Yii::$app->user->can('update-comune') ) {
             $model = $this->findModel($id);
    ...
    {
    	  if((Yii::$app->user->id == 1) || Yii::$app->user->can('delete-comune') ) {
